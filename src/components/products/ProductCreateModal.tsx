...
export function ProductCreateModal({ isOpen, onClose, onSave, isSubmitting }: ProductCreateModalProps) {
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleChange('existencia', parseInt(e.target.value))}
                className={`mt-1 block w-full rounded-md shadow-sm ${
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleChange('margen', parseFloat(e.target.value))}
                  className={`mt-1 block w-full rounded-md shadow-sm ${
              ...
              <div>
                ...
                <input
                  type="number"
                  step="0.01"
                  value={formData.margen2}
                  onChange={(e) => handleChange('margen2', parseFloat(e.target.value))}
                  className={`mt-1 block w-full rounded-md shadow-sm ${
              ...
              <div>
                ...
                <input
                  type="number"
                  step="0.01"
                  value={formData.margen3}
                  onChange={(e) => handleChange('margen3', parseFloat(e.target.value))}
                  className={`mt-1 block w-full rounded-md shadow-sm ${
              ...
              <div>
                ...
                <input
                  type="number"
                  step="0.01"
                  value={formData.margen4}
                  onChange={(e) => handleChange('margen4', parseFloat(e.target.value))}
                  className={`mt-1 block w-full rounded-md shadow-sm ${
