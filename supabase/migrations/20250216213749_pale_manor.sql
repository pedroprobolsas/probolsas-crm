/*
  ...
  1. Tables
    - products: Main table for product information and pricing
...
-- Insert test data
INSERT INTO products (sku, name, regular_price, price_2, price_3, price_4)
VALUES 
  ('BOL-001', 'Bolsa Standard 20x30', 100.00, 90.00, 80.00, 70.00),
  ('BOL-002', 'Bolsa Premium 25x35', 150.00, 135.00, 120.00, 105.00),
  ('BOL-003', 'Bolsa Eco 15x25', 80.00, 72.00, 64.00, 56.00),
  ('BOL-004', 'Bolsa Kraft 30x40', 200.00, 180.00, 160.00, 140.00),
  ('BOL-005', 'Bolsa Biodegradable 20x30', 120.00, 108.00, 96.00, 84.00)
